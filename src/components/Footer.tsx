      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="font-display font-bold text-xl mb-4">AIcraft</h3>
            <p className="text-gray-600 mb-4 max-w-md">
              Building AI solutions that deliver real business value. Let's make technology work for you.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-600 hover:text-primary">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22.5 3.5h-21v17h21v-17zM9.7 17.8l-7-5.4v-7l7 5.4 7-5.4v7l-7 5.4z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="#" className="text-gray-600 hover:text-primary">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#services" className="text-gray-600 hover:text-primary">AI Tool Development</a></li>
              <li><a href="#services" className="text-gray-600 hover:text-primary">AI Integration</a></li>
              <li><a href="#services" className="text-gray-600 hover:text-primary">Consultation</a></li>
              <li><a href="#services" className="text-gray-600 hover:text-primary">Training</a></li>
            </ul>
          </div>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600">© 2025 AIcraft. All rights reserved.</p>
